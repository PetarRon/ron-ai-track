          ...
          style={
            {
              ...
              "--gradient":
                variant === "white"
                  ...
                  : `radial-gradient(circle, #f4d03f 10%, #f4d03f00 20%),
                radial-gradient(circle at 40% 40%, #d4af37 6%, #d4af3700 18%),
                radial-gradient(circle at 60% 60%, #daa520 8%, #daa52000 18%),
                radial-gradient(circle at 40% 60%, #b8860b 8%, #b8860b00 20%),
                repeating-conic-gradient(
                  from 236.84deg at 50% 50%,
                  #f4d03f 0%,
                  ...
                  #f4d03f calc(100% / var(--repeating-conic-gradient-times))
                )`,
